...
#define DUAL_FUNC_17 LT(6, KC_6)
#define DUAL_FUNC_18 LT(15, KC_F12)
#define DUAL_FUNC_19 LT(8, KC_Y)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_HYPR,        KC_MEH,         ST_MACRO_8,     KC_TAB,         DUAL_FUNC_11,   KC_SPACE,                                       DUAL_FUNC_13,   DUAL_FUNC_14,   RCTL(RSFT(KC_TAB)),DUAL_FUNC_15,   KC_BSLS,        KC_RIGHT_GUI,   
...
const uint16_t PROGMEM combo2[] = { TT(1), DUAL_FUNC_0, COMBO_END};
